...
<?php $arr=explode(',',$place->lat_lag) ?>
    ...
    <script>
        function view( x, y)
        {
            ...
            marker.bindPopup("<b>مرحبا</b><br>نحن نتواجد هنا").openPopup();
